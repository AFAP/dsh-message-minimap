...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var TICK_BASE_W = 10;
    var TICK_MAX_W = 19;
    /** Fixed right edge of every tick inside the 20px rail (px); growth extends leftward. */
    var TICK_RIGHT = 19;
      ...
      return jsxs("div", {
        ...
        children: [
          ticks.map(function (tick, index) {
            ...
            // rest width. Inline styles override the class geometry; with no
            // pointer the classes (rest / in-view) apply.
            ...
            if (proxY !== null) {
              ...
              tickStyle.left = Math.round((TICK_RIGHT - width) * 10) / 10 + "px";
